    ...
    <GuestHome>
      <header className="site-header">
        ...
        <div className="header-actions">
          ...
          <Link href="/sign-up" className="button primary small">
      ...
      <main id="main">
        <section className="hero">
          <div className="eyebrow">
            <span className="status-dot" /> PRIVATE SPACES. SHARED CLARITY.
          </div>
          <h1>
          ...
          <p>
            ...
            <br className="desktop-break" /> one bucket at a time.
          </p>
          ...
          <div className="bucket-showcase" aria-label="Illustrative bucket examples">
            <article className="sample-bucket">
            ...
            <article className="sample-bucket featured">
              <div className="sample-top">
                <span className="tile-icon">
                  <Coffee size={21} />
                </span>
                <span className="pill">Solo space</span>
              </div>
              <h2>Personal</h2>
        ...
        <section id="philosophy" className="principles section-wrap">
          <span className="eyebrow">FOUNDATIONAL PRINCIPLES</span>
        ...
        <section id="how-it-works" className="how-section section-wrap">
          <div>
            <span className="eyebrow">DELIBERATE SIMPLICITY</span>
            <h2>
        ...
        <section className="cta-section">
          ...
          <p>
            ...
            <br className="desktop-break" /> or keep it quiet for yourself.
          </p>
          <Link className="button primary" href="/sign-up">
